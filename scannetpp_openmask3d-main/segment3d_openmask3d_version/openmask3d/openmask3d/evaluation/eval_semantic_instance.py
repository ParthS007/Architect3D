...
#python eval_semantic_instance.py --pred_path /work/courses/3dv/20/OpenArchitect3D/eval_results_architectural_classes --gt_path /work/scratch/dbagci/processed/scannetpp/instance_gt/validation/ --split val

# ---------- Label info ---------- #
DATASET_NAME = "scannetpp" # this is the default value, it is overridden if it is another dataset.
