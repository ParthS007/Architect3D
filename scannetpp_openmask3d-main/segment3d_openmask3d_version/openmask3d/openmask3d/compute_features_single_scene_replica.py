...
from openmask3d.mask_features_computation.features_extractor_replica import FeaturesExtractor
import torch
import os

# TIP: add version_base=None to the arguments if you encounter some error
@hydra.main(config_path="configs", config_name="openmask3d_inference_replica")
def main(ctx: DictConfig):
    ...
    # 6. Save features
    scene_name = os.path.join(ctx.data.masks.masks_path).split("/")[-1][:-4]
