...
def print_results(avgs, label_info, output_file="evaluation_results.txt"):
    sep = ""
    col1 = ":"
    lineLen = 64
    ...
    with open(output_file, 'w') as f:
        f.write("\n")
        f.write("#" * lineLen + "\n")
        line = f"{'what':<15}{sep}{col1}{'AP':>15}{sep}{'AP_50%':>15}{sep}{'AP_25%':>15}\n"
        f.write(line)
        f.write("#" * lineLen + "\n")
        ...
        for (li, label_name) in enumerate(label_info.class_labels):
            ...
            ap_50o = avgs["classes"][label_name]["ap50%"]
            ap_25o = avgs["classes"][label_name]["ap25%"]
            line = f"{label_name:<15}{sep}{col1}{ap_avg:>15.3f}{sep}{ap_50o:>15.3f}{sep}{ap_25o:>15.3f}\n"
            f.write(line)
        ...
        all_ap_25o = avgs["all_ap_25%"]
        f.write("-" * lineLen + "\n")
        line = f"{'average':<15}{sep}{col1}{all_ap_avg:>15.3f}{sep}{all_ap_50o:>15.3f}{sep}{all_ap_25o:>15.3f}\n"
        f.write(line)
        f.write("\n")
...
def main(scene_list_file, semantic_classes_file, instance_classes_file, preds_dir, gt_dir, data_root, check_pred_files, output_file="evaluation_results.txt"):
    scene_ids = read_txt_list(scene_list_file)
    semantic_class_list = read_txt_list(semantic_classes_file)
    instance_class_list = read_txt_list(instance_classes_file)
    ...
    results = eval_instance(scene_ids, preds_dir, gt_dir, data_root,
                            label_info, eval_opts, check_pred_files)
    # print everything
...
if __name__ == '__main__':
    main(scene_list_file="/cluster/home/takmaza/scannetpp/nvs_sem_val.txt",
         ...
         preds_dir="/cluster/project/mtc/takmaza/scannetpp_val_gt_processed_NEW/gt_inst_pred_format", 
